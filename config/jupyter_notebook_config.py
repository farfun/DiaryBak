...
def output_post_save(os_path, model, contents_manager):
    print ("output_post_save")
    md_title = os_path.split(".")[0]
    ...
    if ftype == "notebook":
        ...
        subprocess.check_output(
            "pwd && jupyter-nbconvert --to markdown {} && mv {}.md {}".format(
                os_path, md_title, pjoin(dest_dir, dest_name)),
            shell=True)
    else:
