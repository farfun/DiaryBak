    ...
    4: function (e, t, n) {
        ...
        !function (t) {
            !function (e, t, n) {
                ...
                function o(e) {
                    var t = _.className, n = C._config.classPrefix || "";
                ...
                function i(e, t) {
                    if ("object" == typeof e) for (var n in e) b(e, n) && i(n, e[n]); else {
                        e = e.toLowerCase();
                        var r = e.split("."), s = C[r[0]];
                ...
                function h(e, t, o, i) {
                    ...
                    for (h = e.length, c = 0; h > c; c++) if (m = e[c], v = j.style[m], l(m, "-") && (m = p(m)), j.style[m] !== n) {
                ...
                var b, x = [], _ = t.documentElement, T = "svg" === _.nodeName.toLowerCase();
                !function () {
                ...
                var E = "CSS" in e && "supports" in e.CSS, O = "supportsCSS" in e;
                C.addTest("supports", E || O), C.addTest("csstransforms3d", function () {
                    var e = !!y("perspective", "1px", !0), t = C._config.usePrefixes;
