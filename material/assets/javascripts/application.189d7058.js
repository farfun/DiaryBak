!function (e, t) {
    ...
    var i = function () {
        function e(t, n, i) {
            var o = this;
            r(this, e), this.els_ = Array.prototype.slice.call("string" == typeof t ? document.querySelectorAll(t) : [].concat(t)), this.handler_ = "function" == typeof i ? {update: i} : i, this.events_ = [].concat(n), this.update_ = function (e) {
    ...
    (function (e) {
        ...
        function i(t) {
            new f.default.Event.Listener(document, "DOMContentLoaded", function () {
                ...
                if (Array.prototype.forEach.call(t, function (t) {
                        var n = e.createElement("div", {class: "md-typeset__scrollwrap"}, e.createElement("div", {class: "md-typeset__table"}));
                    ...
                    Array.prototype.forEach.call(n, function (t, n) {
                        var r = "__code_" + n, i = e.createElement("button", {
                            class: "md-clipboard",
                            title: h("clipboard.copy"),
                            "data-clipboard-target": "#" + r + " pre, #" + r + " code"
                        }, e.createElement("span", {class: "md-clipboard__message"})), o = t.parentNode;
            ...
            Array.prototype.forEach.call(n, function (e) {
                ...
                return fetch(t.url.base + "/" + (t.version < "0.17" ? "mkdocs" : "search") + "/search_index.json", {credentials: "same-origin"}).then(function (e) {
                    return e.json()
                }).then(function (e) {
                ...
                if (!e.metaKey && !e.ctrlKey) if (t.checked) {
                    if (13 === e.keyCode) {
                    ...
                    } else if (9 === e.keyCode || 27 === e.keyCode) t.checked = !1, t.dispatchEvent(new CustomEvent("change")), n.blur(); else if (-1 !== [8, 37, 39].indexOf(e.keyCode)) n !== document.activeElement && n.focus(); else if (-1 !== [38, 40].indexOf(e.keyCode)) {
                        var i = e.keyCode,
        ...
        var o = n(14), a = r(o), s = n(18), c = r(s), u = n(26), l = r(u), d = n(27), f = r(d);
    ...
    (function (e, t) {
        !function (e, n) {
            ...
            if (!e.setImmediate) {
                var s, c = 1, u = {}, l = !1, d = e.document, f = Object.getPrototypeOf && Object.getPrototypeOf(e);
    ...
    var r, i, o;
    !function (a, s) {
        i = [e, n(19), n(21), n(22)], r = s, void 0 !== (o = "function" == typeof r ? r.apply(t, i) : r) && (e.exports = o)
    }(0, function (e, t, n, r) {
        "use strict";
    ...
    var r, i, o;
    !function (a, s) {
        i = [e, n(20)], r = s, void 0 !== (o = "function" == typeof r ? r.apply(t, i) : r) && (e.exports = o)
    }(0, function (e, t) {
        "use strict";
    ...
    !function () {
        ...
        var o = navigator.userAgent.indexOf("Windows Phone") >= 0, a = navigator.userAgent.indexOf("Android") > 0 && !o,
            s = /iP(ad|hone|od)/.test(navigator.userAgent) && !o, c = s && /OS 4_\d(_\d)?/.test(navigator.userAgent),
    ...
    t.__esModule = !0;
    var i = n(28), o = r(i), a = n(30), s = r(a), c = n(33), u = r(c), l = n(37), d = r(l), f = n(43), h = r(f),
        p = n(45), m = r(p), v = n(51), y = r(v);
    t.default = {
        Event: o.default,
        Header: s.default,
        Nav: u.default,
    ...
    t.__esModule = !0;
    var i = n(3), o = r(i), a = n(29), s = r(a);
    t.default = {Listener: o.default, MatchMedia: s.default}
}, function (e, t, n) {
    "use strict";
    ...
    t.__esModule = !0;
    var i = n(31), o = r(i), a = n(32), s = r(a);
    t.default = {Shadow: o.default, Title: s.default}
}, function (e, t, n) {
    "use strict";
    ...
    var i = function () {
        ...
        return e.prototype.setup = function () {
            ...
            var t = this, n = window.pageYOffset >= this.header_.offsetTop;
    ...
    t.__esModule = !0;
    var i = n(34), o = r(i), a = n(35), s = r(a), c = n(36), u = r(c);
    t.default = {Blur: o.default, Collapse: s.default, Scrolling: u.default}
}, function (e, t, n) {
    "use strict";
    ...
    var i = function () {
        ...
        return e.prototype.setup = function () {
            ...
            var e = window.pageYOffset, t = this.offset_ - e < 0;
            if (this.dir_ !== t && (this.index_ = this.index_ = t ? 0 : this.els_.length - 1), 0 !== this.anchors_.length) {
                if (this.offset_ <= e) for (var n = this.index_ + 1; n < this.els_.length && this.anchors_[n].offsetTop - 80 <= e; n++) n > 0 && (this.els_[n - 1].dataset.mdState = "blur"), this.index_ = n; else for (var r = this.index_; r >= 0; r--) {
    ...
    var i = function () {
        ...
        return e.prototype.setup = function () {
            ...
            var e = this, t = this.el_.getBoundingClientRect().height;
        ...
        return e.prototype.setup = function () {
            ...
            Array.prototype.forEach.call(e, function (e) {
                ...
                if (e.checked) {
                    ...
                    var n = e.parentNode.parentNode, r = t.children[t.children.length - 1];
            ...
            var r = t.parentNode.parentNode, i = n.children[n.children.length - 1];
    ...
    t.__esModule = !0;
    var i = n(38), o = r(i), a = n(39), s = r(a);
    t.default = {Lock: o.default, Result: s.default}
}, function (e, t, n) {
    "use strict";
    ...
    (function (e) {
        ...
        t.__esModule = !0;
        var o = n(40), a = r(o), s = n(41), c = r(s), u = function (e, t) {
            var n = t;
            if (e.length > n) {
                for (; " " !== e[n] && --n > 0;) ;
            ...
            function t(e, n) {
                ...
                if (!(r instanceof HTMLElement)) throw new ReferenceError;
                this.el_ = r;
                var o = Array.prototype.slice.call(this.el_.children), a = o[0], s = o[1];
                ...
                if ("focus" !== t.type || this.index_) {
                    if ("focus" === t.type || "keyup" === t.type) {
                        ...
                        var i = this.index_.query(function (e) {
                                n.value_.toLowerCase().split(" ").filter(Boolean).forEach(function (t) {
                                    e.term(t, {wildcard: c.default.Query.wildcard.TRAILING})
                                })
                            }).reduce(function (e, t) {
                        ...
                        this.stack_ = [], i.forEach(function (t, r) {
                            var i, o = n.docs_.get(r),
                                a = e.createElement("li", {class: "md-search-result__item"}, e.createElement("a", {
                                    href: o.location,
                                    title: o.title,
                                    class: "md-search-result__link",
                                    tabindex: "-1"
                                }, e.createElement("article", {class: "md-search-result__article md-search-result__article--document"}, e.createElement("h1", {class: "md-search-result__title"}, {__html: o.title.replace(s, d)}), o.text.length ? e.createElement("p", {class: "md-search-result__teaser"}, {__html: o.text.replace(s, d)}) : {}))),
                                c = t.map(function (t) {
                                    return function () {
                                        var r = n.docs_.get(t.ref);
                                        a.appendChild(e.createElement("a", {
                                            ...
                                            "data-md-rel": "anchor",
                                            tabindex: "-1"
                                        }, e.createElement("article", {class: "md-search-result__article"}, e.createElement("h1", {class: "md-search-result__title"}, {__html: r.title.replace(s, d)}), r.text.length ? e.createElement("p", {class: "md-search-result__teaser"}, {__html: u(r.text.replace(s, d), 400)}) : {})))
                                    }
                                });
                    ...
                    var p = function (e) {
                        ...
                        n.stack_ = [], n.index_ = (0, c.default)(function () {
                            ...
                            this.pipeline.reset(), o && (e = this.pipeline).add.apply(e, o), 1 === r.length && "en" !== r[0] && c.default[r[0]] ? this.use(c.default[r[0]]) : r.length > 1 && this.use(c.default.multiLanguage.apply(c.default, r)), this.field("title", {boost: 10}), this.field("text"), this.ref("location"), t.forEach(function (e) {
                                return n.add(e)
                            })
                        });
    ...
    !function () {
        ...
        o.version = "2.1.5", o.utils = {}, o.utils.warn = function (e) {
            ...
            var e = {
                ...
                r = "[^aeiou][^aeiouy]*", i = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"),
                ...
                s = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"), c = /^(.+?)(ss|i)es$/, u = /^(.+?)([^s])s$/,
                l = /^(.+?)eed$/, d = /^(.+?)(ed|ing)$/, f = /.$/, h = /(at|bl|iz)$/,
                p = new RegExp("([^aeiouylsz])\\1$"), m = new RegExp("^" + r + n + "[^aeiouwxy]$"),
                v = /^(.+?[^aeiou])y$/,
                ...
                _ = /^(.+?)(s|t)(ion)$/, E = /^(.+?)e$/, x = /ll$/, b = new RegExp("^" + r + n + "[^aeiouwxy]$"),
                k = function (n) {
                    var r, k, T, S, L, C, M;
            ...
            for (var n = new o.TokenSet, r = [{node: n, editsRemaining: t, str: e}]; r.length;) {
                var i = r.pop();
                if (i.str.length > 0) {
                ...
                if (i.editsRemaining > 0 && 1 == i.str.length && (i.node.final = !0), i.editsRemaining > 0 && i.str.length >= 1) {
                    if ("*" in i.node.edges) var u = i.node.edges["*"]; else {
                ...
                if (i.editsRemaining > 0) {
                    if ("*" in i.node.edges) var l = i.node.edges["*"]; else {
                ...
                if (i.editsRemaining > 0 && i.str.length > 1) {
                    var d, f = i.str.charAt(0), h = i.str.charAt(1);
            ...
            for (var t = new o.TokenSet, n = t, r = !1, i = 0, a = e.length; i < a; i++) {
                var s = e[i], c = i == a - 1;
                if ("*" == s) r = !0, t.edges[s] = t, t.final = c; else {
                    var u = new o.TokenSet;
            ...
            for (var e = [], t = [{prefix: "", node: this}]; t.length;) {
                var n = t.pop(), r = Object.keys(n.node.edges), i = r.length;
            ...
            for (var t = new o.TokenSet, n = void 0, r = [{qNode: e, output: t, node: this}]; r.length;) {
                n = r.pop();
                for (var i = Object.keys(n.qNode.edges), a = i.length, s = Object.keys(n.node.edges), c = s.length, u = 0; u < a; u++) for (var l = i[u], d = 0; d < c; d++) {
                    var f = s[d];
                    if (f == l || "*" == l) {
                        var h = n.node.edges[f], p = n.qNode.edges[l], m = h.final && p.final, v = void 0;
            ...
            for (var r = n; r < e.length; r++) {
                var i = new o.TokenSet, a = e[r];
                t.edges[a] = i, this.uncheckedNodes.push({parent: t, char: a, child: i}), t = i
            }
            ...
            for (var t = this.uncheckedNodes.length - 1; t >= e; t--) {
                var n = this.uncheckedNodes[t], r = n.child.toString();
            ...
            var t = new o.Query(this.fields), n = Object.create(null), r = Object.create(null), i = Object.create(null);
            e.call(t, t);
            for (var a = 0; a < t.clauses.length; a++) {
                var s = t.clauses[a], c = null;
                c = s.usePipeline ? this.pipeline.runString(s.term) : [s.term];
                for (var u = 0; u < c.length; u++) {
                    var l = c[u];
                    s.term = l;
                    for (var d = o.TokenSet.fromClause(s), f = this.tokenSet.intersect(d).toArray(), h = 0; h < f.length; h++) for (var p = f[h], m = this.invertedIndex[p], v = m._index, y = 0; y < s.fields.length; y++) {
                        var g = s.fields[y], w = m[g], _ = Object.keys(w), E = p + "/" + g;
                        if (void 0 === r[g] && (r[g] = new o.Vector), r[g].upsert(v, 1 * s.boost, function (e, t) {
                                return e + t
                            }), !i[E]) {
                            for (var x = 0; x < _.length; x++) {
                                var b, k = _[x], T = new o.FieldRef(k, g), S = w[k];
            ...
            for (var L = Object.keys(n), C = [], M = Object.create(null), a = 0; a < L.length; a++) {
                var O, A = o.FieldRef.fromString(L[a]), R = A.docRef, I = this.fieldVectors[A],
                    P = r[A.fieldName].similarity(I);
                if (void 0 !== (O = M[R])) O.score += P, O.matchData.combine(n[A]); else {
                    var N = {ref: R, score: P, matchData: n[A]};
                    M[R] = N, C.push(N)
                }
            }
            ...
            }, this), t = Object.keys(this.fieldVectors).map(function (e) {
            ...
            var t = {}, n = {}, r = e.fieldVectors, i = {}, a = e.invertedIndex, s = new o.TokenSet.Builder,
            ...
            for (var u = 0; u < r.length; u++) {
                var l = r[u], d = l[0], f = l[1];
                n[d] = new o.Vector(f)
            }
            for (var u = 0; u < a.length; u++) {
                var l = a[u], h = l[0], p = l[1];
                s.insert(h), i[h] = p
            }
            ...
            for (var n = 0; n < this._fields.length; n++) {
                var r = this._fields[n], i = e[r], a = this.tokenizer(i), s = this.pipeline.run(a),
                    c = new o.FieldRef(t, r), u = Object.create(null);
                ...
                for (var l = 0; l < s.length; l++) {
                    ...
                    for (var p = 0; p < this.metadataWhitelist.length; p++) {
                        var m = this.metadataWhitelist[p], v = d.metadata[m];
            ...
            for (var e = Object.keys(this.fieldLengths), t = e.length, n = {}, r = {}, i = 0; i < t; i++) {
                var a = o.FieldRef.fromString(e[i]), s = a.fieldName;
            ...
            for (var e = {}, t = Object.keys(this.fieldTermFrequencies), n = t.length, r = Object.create(null), i = 0; i < n; i++) {
                for (var a = o.FieldRef.fromString(t[i]), s = a.fieldName, c = this.fieldLengths[a], u = new o.Vector, l = this.fieldTermFrequencies[a], d = Object.keys(l), f = d.length, h = 0; h < f; h++) {
                    var p, m, v, y = d[h], g = l[y], w = this.invertedIndex[y]._index;
            ...
            for (var t = Object.keys(e.metadata), n = 0; n < t.length; n++) {
                var r = t[n], i = Object.keys(e.metadata[r]);
                void 0 == this.metadata[r] && (this.metadata[r] = Object.create(null));
                for (var o = 0; o < i.length; o++) {
                    var a = i[o], s = Object.keys(e.metadata[r][a]);
            ...
            if (void 0 != t) {
                if (-1 == e.query.allFields.indexOf(t.str)) {
                    var n = e.query.allFields.map(function (e) {
                        return "'" + e + "'"
                    }).join(", "), r = "unrecognised field '" + t.str + "', possible fields: " + n;
    ...
    "use strict";
    t.__esModule = !0;
    var r = n(44), i = function (e) {
        return e && e.__esModule ? e : {default: e}
    }(r);
    t.default = {Position: i.default}
}, function (e, t, n) {
    "use strict";
    ...
    var i = function () {
        ...
        return e.prototype.setup = function () {
            ...
            var t = window.pageYOffset, n = window.innerHeight;
    ...
    t.__esModule = !0;
    var i = n(46), o = r(i), a = n(50), s = r(a);
    t.default = {Adapter: o.default, Repository: s.default}
}, function (e, t, n) {
    "use strict";
    t.__esModule = !0;
    ...
    t.__esModule = !0;
    var a = n(48), s = function (e) {
        return e && e.__esModule ? e : {default: e}
    }(a), c = function (e) {
        function t(n) {
            r(this, t);
            var o = i(this, e.call(this, n)), a = /^.+github\.com\/([^\/]+)\/?([^\/]+)?.*$/.exec(o.base_);
            if (a && 3 === a.length) {
                var s = a[1], c = a[2];
        ...
        return e.prototype.fetch = function () {
            ...
            return new Promise(function (t) {
                ...
                void 0 !== n ? t(n) : e.fetch_().then(function (n) {
                    o.default.set(e.salt_ + ".cache-source", n, {expires: 1 / 96}), t(n)
                })
            })
            ...
            function r(t, i, o) {
                ...
                if ("undefined" != typeof document) {
                    ...
                    for (var l = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, f = 0; f < l.length; f++) {
                        var h = l[f].split("="), p = h.slice(1).join("=");
    ...
    (function (e) {
        ...
        var r = function () {
            ...
            return t.prototype.initialize = function (t) {
                t.length && this.el_.children.length && this.el_.children[this.el_.children.length - 1].appendChild(e.createElement("ul", {class: "md-source__facts"}, t.map(function (t) {
                    return e.createElement("li", {class: "md-source__fact"}, t)
