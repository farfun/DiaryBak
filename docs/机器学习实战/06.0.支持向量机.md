...
![线性可分](resources/6.SVM/SVM_3_linearly-separable.jpg)
...
![分隔超平面](resources/6.SVM/SVM_2_separating-hyperplane.jpg)
...
![点到直线的几何距离](resources/6.SVM/SVM_4_point2line-distance.jpg)
...
* 现在转化到对偶问题的求解
    ...
    * 参考： 如果公式推导还是不懂，也可以参考《统计学习方法》李航-P103<学习的对偶算法>
    ![计算拉格朗日函数的对偶函数](resources/6.SVM/SVM_5_Lagrangemultiplier.png)
...
![径向基函数的高斯版本](resources/6.SVM/SVM_6_radial-basis-function.jpg)
