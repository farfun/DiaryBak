...
![支持向量机公式]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/supportVector公式.jpg "supportVector公式")

在这个表达式中，只有支持向量的系数 ![alphai]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/alpha.png "alphai") 不等于 0 。

如果还是不怎么理解，不要紧，看下图:

![supportVector]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/supportVector.png "supportVector")
...
![supportVectorMachine]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/svm_2.png "supportVectorMachine")
...
![story_1]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_1.png "story_1")

于是大侠这样放，干的不错？ 

![story_2]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_2.png "story_2")

然后魔鬼，又在桌上放了更多的球，似乎有一个球站错了阵营。

![story_3]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_3.png "story_3")

SVM 就是试图把棍放在最佳位置，好让在棍的两边有尽可能大的间隙。

![story_4]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_4.png "story_4")

现在即使魔鬼放了更多的球，棍仍然是一个好的分界线。

![story_5]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_5.png "story_5")

然后，在 SVM 工具箱中有另一个更加重要的 trick。 魔鬼看到大侠已经学会了一个 trick ，于是魔鬼给了大侠一个新的挑战。

![story_6]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_6.png "story_6")

现在，大侠没有棍可以很好帮他分开两种球了，现在怎么办呢？当然像所有武侠片中一样大侠桌子一拍，球飞到空中。然后，凭借大侠的轻功，大侠抓起一张纸，插到了两种球的中间。

![story_7]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_7.png "story_7")

现在，从魔鬼的角度看这些球，这些球看起来像是被一条曲线分开了。

![story_8]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/story_8.png "story_8")
...
![hu_1]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_1.jpg "hu_1")

那我们如何选择这个分类超平面呢？从数学上说，超平面的公式是,也就是说如何选取这个 ![w]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/w.png "w")（是个向量）。

传统方法是根据最小二乘错误法（least squared error），首先随便定选取一个随机平面，也就是随机选取 ![w]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/w.png "w") 和 ![b]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/b.png "b")，然后想必会在训练集中产生大量的错误分类，也就是说，![wtx+b]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_5.png "wtx+b") 结果应该大于 0 的时候小于 0 ，应该小于 0 的时候大于 0 。这时候有一个错误损失，也就是说对于所有错误的分类，他们的平方和（least squared error） 为: ![平方和]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_8.png "平方和") , 最小二乘法的目标就是让这个值趋于最小，对 ![w]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/w.png "w") 求导取 0 ，采用梯度下降算法，可以求出错误平方和的极值，求出最优的 ![w]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/w.png "w") ，也就是求出最优的超平面。（可以证明，如果基函数是指数族函数，求出的超平面是全局最优的）。
...
![hu_2]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_2.jpg "hu_2")
...
![hu_3]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_3.png "hu_3")

然后对于所有的支持向量，使他们到超平面 ![hu_5]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_5.png "hu_5") 的距离最大，也就是

![hu_4]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_4.png "hu_4")

因为对于所有支持向量，他们 ![hu_5]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_5.png "hu_5") 的值都是一定的，我们假设恒等于 1 ，那么上式变成了 ![hu_6]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_6.png "hu_6") ,并且对于所有的样本点，满足 ![hu_10]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/hu_10.png "hu_10") 的约束，因此，可以利用拉格朗日乘数法计算出它的极值。也就是求出这个超平面。
...
![k_1]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_1.jpg "k_1")
...
![k_7]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_7.png "k_7")
...
其中距离，说白了就是点到直线的距离；只要定义带正负号的距离，是 {苹果+1} 面为正 {香蕉-1} 面为负的距离，互相乘上各自的 label ![k_8]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_8.png "k_8") ，就和谐统一民主富强了。

![k_9]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_9.png "k_9")
...
![k_10]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_10.png "k_10")
...
![k_11]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_11.png "k_11")

稍微借用刚刚数学表达里面的内容看个有趣的东西：

还记得我们怎么预测一个新的水果是苹果还是香蕉吗？我们代入到分界的直线里，然后通过符号来判断。

刚刚w已经被表达出来了也就是说这个直线现在变成了： ![k_12]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_12.png "k_12")

看似仿佛用到了所有的训练水果，但是其中 ![k_13]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_13.png "k_13") 的水果都没有起到作用，剩下的就是小部分靠边边的 Support vectors 呀。

<b>III. dual representation</b>

![k_14]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_14.png "k_14")

<b>如果香蕉和苹果不能用直线分割呢？</b>

![k_3]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_3.jpg "k_3")

Kernel trick. 

其实用直线分割的时候我们已经使用了 kernel ，那就是线性 kernel , ![k_15]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_15.png "k_15")
...
![k_4]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_4.jpg "k_4")

![k_16]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_16.png "k_16")

<b>如果还有梨呢？</b>

![k_5]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_5.jpg "k_5")
...
![k_6]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/k_6.png "k_6")
...
![sklearn_map]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/6.SVM/ml_map.png "sklearn")
