...
![决策树-流程图]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/3.DecisionTree/决策树-流程图.jpg "决策树示例流程图")
...
[完整代码地址](https://github.com/apachecn/MachineLearning/blob/python-2.7/src/python/3.DecisionTree/DecisionTree.py): <https://github.com/apachecn/MachineLearning/blob/master/src/python/3.DecisionTree/DecisionTree.py>
...
![海洋生物数据]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/3.DecisionTree/DT_海洋生物数据.png)
...
![熵的计算公式]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/3.DecisionTree/熵的计算公式.jpg)
