...
![基于 CART 算法构建回归树的简单数据集](resources/9.TreeRegression/RegTree_1.png)  

用于测试回归树的分段常数数据集  
![用于测试回归树的分段常数数据集](resources/9.TreeRegression/RegTree_2.png)  
...
![分段线性数据](resources/9.TreeRegression/RegTree_3.png)
...
![模型树运行结果](resources/9.TreeRegression/RegTree_4.png)
...
![骑自行车速度和智商之间的关系](resources/9.TreeRegression/RegTree_5.png)
...
![GUI示例图](resources/9.TreeRegression/GUI示例图.png "GUI示例图")
...
![取得更好预测效果的GUI示例图](resources/9.TreeRegression/GUI更好的示例图.png "取得更好预测效果的GUI示例图")
