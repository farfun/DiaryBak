...
![关联分析示例1]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/11.Apriori/apachecn_apriori_association_demo_1.jpg)
...
所有可能的情况如下:  
![4种商品的所有组合]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/11.Apriori/apachecn_apriori_goods_all_1.jpg)  
...
![非频繁项集]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/11.Apriori/非频繁项集.png)
...
![关联规则网格示意图]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/11.Apriori/apachecn_association_rule_demo_1.jpg)  
...
* 分级法： 频繁项集->关联规则
    ...
    * 如下图：
    * ![所有可能的项集组合]({{ site.baseurl }}{{ site.images }}/MachineLearninginAction/11.Apriori/所有可能的项集组合.png)
